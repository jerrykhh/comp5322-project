...
const AdminPage = ({ pageName, children }: AdminPageProps): JSX.Element => {
    return (
        <React.Fragment>
            <AdminNav routers={routes} />
            <div className="relative md:ml-64">
                <AdminHeader pageName={pageName}/>
                <div className="relative bg-bluegray-800 md:pt-32 pb-32 pt-12 -z-10" />
                <div className="px-4 md:px-10 mx-auto w-full">
                    <div className="px-4 md:px-10 mx-auto w-full -m-24 z-10">
                        <div className="bg-white min-h-screen md:min-h-[80vh] border">
                            <div className="p-12">
                            {children}
                            </div>
                        </div>
...
const AdminNav = ({ routers }: AdminNavRoutersProps) => {
