...
const LoginPage = () => {
    ...
    useEffect(() => {
        ...
        const { c, rc } = router.query;
        if (c)
            setSucMes(`Account ${c} is created`)
        if (rc)
            setSucMes(`Account ${rc} is recovered`)
                    ...
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <div className="w-full">
                            {sucMes !== "" ?
                                ...
                                <div className="bg-teal-100 border rounded  border-teal-500 text-teal-700 px-4 py-3" role="alert">
                        ...
                        <div className="space-y-4 md:space-y-6">
                            ...
                            <div className="flex items-center justify-between">
                                <Link href="/forget"><div className="cursor-pointer text-sm font-medium hover:underline dark:text-primary-500">Forgot password?</div></Link>
                            </div>
